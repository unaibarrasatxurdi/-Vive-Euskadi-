    ...
    <div class="row">
      <div class="col 5">
        <div class="row">
          <p>Patrocinadores:</p>
          <img
            src="/images/euskadi-basque-country.png"
            class="img-fluid patrocinadores"
          />
          <img src="/images/Bilbao.png" class="img-fluid patrocinadores" />
          <img
            src="/images/r01ClaimH_white_es.png"
            class="img-fluid patrocinadores"
          />
          <img
        ...
        <div class="row">
          ...
          <img
            src="/images/Logo-Orain-Ingurumena.png"
            class="img-fluid patrocinadores"
          />
          ...
          />
          <img
            src="/images/Gobierno-Vasco-Eusko-Jaurlaritza.png"
            class="img-fluid patrocinadores"
          />
        </div>
      </div>
      <div class="col 3 align-self-center">
        <div class="row">
          <p class="text-center">
            &copy;Todos los derechos reservados. Vive Euskadi S.L.
          </p>
        </div>
